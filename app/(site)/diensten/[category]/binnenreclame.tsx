...
const process = [
  {
    number: "01",
    title: "Analyse",
    text: "We analyseren ruimtes, zichtlijnen en merkidentiteit om een interieurconcept te creëren dat rust en herkenbaarheid uitstraalt.",
    image: "/assets/images/process/interieur-analyse.webp",
  },
  {
    number: "02",
    title: "Concept",
    text: "Van materiaalkeuze en routing tot typografie en positionering. Alles wordt ontworpen als één geheel.",
    image: "/assets/images/process/interieur-concept.webp",
  },
  {
    number: "03",
    title: "Productie",
    text: "Precisiewerk in eigen productie met hoogwaardige folies, prints en afwerkingen voor een premium uitstraling.",
    image: "/assets/images/process/interieur-productie.webp",
  },
  {
    number: "04",
    title: "Montage",
    text: "Professionele plaatsing met minimale verstoring en maximale aandacht voor detail en afwerking.",
    image: "/assets/images/process/interieur-montage.webp",
  },
]
    ...
    >
      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="parallax-image absolute inset-0 scale-105">
            <Image
              src="/assets/images/services/interieur-hero.webp"
              alt="Interieur signing"
              fill
              priority
        ...
        <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl items-center px-6 lg:px-10">
          ...
          <div className="max-w-5xl">
            ...
            <p className="hero-reveal mt-10 max-w-2xl text-lg leading-[1.9] text-white/50 md:text-xl">
              Van wayfinding en wandvisuals tot complete interieur branding.
              Signing die rust, herkenbaarheid en beleving creëert.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="reveal-section grid gap-16 lg:grid-cols-12">
            ...
            <div className="lg:col-span-8">
              ...
              <p className="mt-10 max-w-2xl text-lg leading-[1.9] text-white/45">
                Interieur signing brengt rust, routing en identiteit samen.
                Van subtiele glasfolie tot complete branded environments.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="parallax-image absolute inset-0 scale-105">
            <Image
              src="/assets/images/services/interieur-branding.webp"
              alt="Interieur branding"
              fill
              className="object-cover"
            />
          </div>
        ...
        <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl items-center px-6 lg:px-10">
          ...
          <div className="reveal-section max-w-3xl">
            ...
            <p className="mt-8 max-w-xl text-lg leading-[1.8] text-white/50 md:text-xl">
              Van wandvisuals tot complete branded spaces die rust en identiteit uitstralen.
            </p>

            <div className="mt-14 flex flex-col gap-4">
              {branding.map((service) => (
                <Link
                  key={service}
                  href={`/diensten/interieur/${service
                    .toLowerCase()
                    .replace(/\s+/g, "-")}`}
      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="parallax-image absolute inset-0 scale-105">
            <Image
              src="/assets/images/services/interieur-wayfinding.webp"
              alt="Wayfinding"
              fill
              className="object-cover"
            />
        ...
        <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl items-center justify-end px-6 lg:px-10">
          ...
          <div className="reveal-section max-w-3xl">
            ...
            <p className="mt-8 max-w-xl text-lg leading-[1.8] text-white/50 md:text-xl">
              Heldere routing en slimme navigatie voor kantoren, retail en publieke ruimtes.
            </p>
      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="parallax-image absolute inset-0 scale-105">
            <Image
              src="/assets/images/services/interieur-office.webp"
        ...
        <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl items-center px-6 lg:px-10">
          ...
          <div className="reveal-section max-w-3xl">
            ...
            <p className="mt-8 max-w-xl text-lg leading-[1.8] text-white/50 md:text-xl">
              Slimme oplossingen voor privacy, akoestiek en branded werkplekken.
            </p>
        ...
        <div className="mx-auto grid max-w-7xl gap-20 px-6 lg:grid-cols-12 lg:px-10">
          ...
          <div className="process-sticky h-fit lg:col-span-4 lg:top-32">
            ...
            <p className="mt-8 max-w-sm text-lg leading-[1.8] text-white/45">
              Van eerste analyse tot perfecte montage.
              Elk detail wordt ontworpen, geproduceerd en afgewerkt met precisie.
            </p>
          </div>
            ...
            {[1, 2, 3].map((item) => (
              ...
              >
                <div className="relative aspect-[4/5] overflow-hidden">
                  ...
                  <Image
                    src={`/assets/images/projects/interieur-${item}.webp`}
                    alt="Project"
                    fill
      ...
      <section className="relative overflow-hidden border-t border-white/[0.08] py-40">
        ...
        <div className="reveal-section relative z-10 mx-auto max-w-5xl px-6 text-center lg:px-10">
          ...
          <p className="text-[11px] uppercase tracking-[0.28em] text-white/35">
            Klaar om je interieur te versterken?
          </p>
          ...
          <p className="mx-auto mt-10 max-w-2xl text-lg leading-[1.9] text-white/45 md:text-xl">
            Samen creëren we interieur signing die rust,
            herkenbaarheid en uitstraling samenbrengt.
          </p>
